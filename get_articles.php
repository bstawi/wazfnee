<?php
    ...
    function getDataFromRequest() {
        ...
        $GLOBALS['orderBy']     = getValueFromGet(value: 'orderBy') == null ? 'customOrder ASC' : getValueFromGet(value: 'orderBy');
    }
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if(isExistAnyDataEmpty()) {
            ...
            // Search
            $searchQuery = '(titleAr LIKE ? OR titleEn LIKE ?)';
            ...
            // Filters Query
            $filtersQuery = "$startDateOfCreatedQuery $endDateOfCreatedQuery $isAvailableQuery";

            $total = countRows(table: 'articles', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue, $searchValue));
            ...
            if(isPageRangeValid($page, $pagesNumber) || $page == 1) {
                ...
                $articles = getAll(table: 'articles', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue, $searchValue), orderBy: $GLOBALS['orderBy'], limit: $limit, offset: $offset);
