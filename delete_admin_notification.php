<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(isExistAnyDataEmpty()) {
            ...
            deleteWithId(table: 'admin_notifications', column: 'adminNotificationId', id: $GLOBALS['adminNotificationId']);

            $result = [
                'base' => [
                    'status' => true,
                    'messageAr' => 'تم حذف الاشعار بنجاح',
                    'messageEn' => 'The notification has been deleted successfully',
                ],
            ];
        }
    }
