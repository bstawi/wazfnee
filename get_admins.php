<?php
    ...
    function getDataFromRequest() {
        ...
        $GLOBALS['orderBy']     = getValueFromGet(value: 'orderBy') == null ? 'adminId DESC' : getValueFromGet(value: 'orderBy');
    }
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if(isExistAnyDataEmpty()) {
            ...
            // Filters Query
            $filtersQuery = "$genderQuery $startDateOfCreatedQuery $endDateOfCreatedQuery";

            $total = countRows(table: 'admins', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue));
            ...
            if(isPageRangeValid($page, $pagesNumber) || $page == 1) {
                ...
                $admins = getAll(table: 'admins',  where: "$searchQuery $filtersQuery", valuesArray: array($searchValue), orderBy: $GLOBALS['orderBy'], limit: $limit, offset: $offset);
