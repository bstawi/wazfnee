<?php
    ...
    function getDataFromRequest() {
        ...
        $GLOBALS['orderBy']         = getValueFromGet(value: 'orderBy') == null ? 'seekerId DESC' : getValueFromGet(value: 'orderBy');
    }
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if(isExistAnyDataEmpty()) {
            ...
            // Filters Query
            $filtersQuery = "$startDateOfCreatedQuery $endDateOfCreatedQuery $isAvailableQuery $categoryIdQuery $userIdQuery $countryIdQuery $isFeaturedQuery $adStatusQuery";

            $total = countRows(table: 'seekers', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue));
