<?php
    ...
    function getDataFromRequest() {
        ...
        $GLOBALS['orderBy']     = getValueFromGet(value: 'orderBy') == null ? 'categoryId DESC' : getValueFromGet(value: 'orderBy');
    }
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if(isExistAnyDataEmpty()) {
            ...
            // Search
            $searchQuery = '(nameAr LIKE ? OR nameEn LIKE ?)';
            ...
            $total = countRows(table: 'categories', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue, $searchValue));
            ...
            if(isPageRangeValid($page, $pagesNumber) || $page == 1) {
                ...
                $categories = getAll(table: 'categories', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue, $searchValue), orderBy: $GLOBALS['orderBy'], limit: $limit, offset: $offset);
