<?php
    ...
    function getDataFromRequest() {
        ...
        $GLOBALS['orderBy']     = getValueFromGet(value: 'orderBy') == null ? 'sliderId DESC' : getValueFromGet(value: 'orderBy');
    }
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if(isExistAnyDataEmpty()) {
            ...
            $total = countRows(table: 'sliders', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue));
            ...
            if(isPageRangeValid($page, $pagesNumber) || $page == 1) {
                ...
                $sliders = getAll(table: 'sliders', where: "$searchQuery $filtersQuery", valuesArray: array($searchValue), orderBy: $GLOBALS['orderBy'], limit: $limit, offset: $offset);
